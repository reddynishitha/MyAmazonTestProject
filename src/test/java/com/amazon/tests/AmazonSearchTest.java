...
public class AmazonSearchTest {
	...
	search_amazon() {
		...
		AmazonRegistrationPage registerUser=signinUser.NewCustomerSignIn("testamazonuser21@gmail.com");
		AmazonSelectDeliveryAdressPage selectAddress=registerUser.registerUser("testamazonuser21@gmail.com");
